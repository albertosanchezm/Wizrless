...
- **Engine**: Godot 4.6
- **Language**: GDScript
- **Rendering**: Godot Rendering Server (2D — CanvasItem / RenderingServer)
...
- **Touch Support**: None
- **Platform Notes**: All UI should support both keyboard and gamepad navigation. No hover-only interactions.
...
- **Frame Budget**: 16.6ms
- **Draw Calls**: ~500 (2D metroidvania target)
